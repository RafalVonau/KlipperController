...
public class FilePickerDelegate implements PluginRegistry.ActivityResultListener, PluginRegistry.RequestPermissionsResultListener {
                    ...
                    if (data != null) {
                        ...
                        if (data.getClipData() != null) {
                            ...
                            while (currentItem < count) {
                                ...
                                final FileInfo file = FileUtils.openFileStream(FilePickerDelegate.this.activity, currentUri, loadDataToMemory, sendToIP);
                            ...
                            final FileInfo file = FileUtils.openFileStream(FilePickerDelegate.this.activity, uri, loadDataToMemory,sendToIP);
    ...
    @SuppressWarnings("deprecation")
    public void startFileExplorer(final String type, final boolean isMultipleSelection, final boolean withData, final String sendToIP,final String[] allowedExtensions, final MethodChannel.Result result) {
